...
for data_name in name_list:
    ...
    weight_path = save_path +data_type1+'_'+data_type2+'/'+data_name+'/mlp_weight/'
    ...
    trainS = np.concatenate((trainS1,trainS2),axis = 1)
    testS = np.concatenate((testS1,testS2),axis = 1)
    # labelTr = np.argmax((labelTr),axis = 1)
    # labelTs = np.argmax((labelTs),axis = 1)
    del trainS1,trainS2,testS1,testS2
