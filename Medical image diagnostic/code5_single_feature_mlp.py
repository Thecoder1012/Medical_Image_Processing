...
for data_name in name_list:
    ...
    weight_path = save_path +'/'+data_type+'/'+data_name+'/'+'/mlp_weight/'
    ...
    trainS,labelTr, testS, labelTs = load_intermediate_data(data_name,data_type)
    ...
    #%%
    seeds = np.random.randint(0,1000,1)#[308,951,14,619,764,702,722,616,570,597]
