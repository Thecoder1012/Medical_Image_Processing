...
for k in range(0,5):
    ...
    weight_path ='./COVID19/dct/fold'+str(k+1)+'/mlp_weight/'  # dct or dwt or pixel
    ...
    counter = counter + 12
    wb.save('./COVID19/dct/fold'+str(k+1)+'/result.xls')  # dct or dwt or pixel
