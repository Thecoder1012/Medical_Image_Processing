...
Folder **Medical image diagnostic** mentions the code of the paper **"A Deep Learning Framework Integrating the Spectral and Spatial Features for Image-Assisted Medical Diagnostics"**,
Published in: **IEEE Access ( Volume: 9)**. **DOI:** https://doi.org/10.1109/ACCESS.2021.3133338

## Model Configuration for "Do Pre-processing and Class Imbalance Matter to the Deep Image Classifiers for COVID-19 Detection An Explainable Analysis"
